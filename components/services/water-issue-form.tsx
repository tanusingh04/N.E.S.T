// components/services/water-issue-form.tsx
"use client"
...
export function WaterIssueForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportData = {
        title: `Water Issue: ${issueType}`,
        description,
        category: "water",
        subcategory: issueType.toLowerCase(),
        severity: issueType === "outage" ? "high" : "medium",
        location: {
          type: "Point",
      ...
      toast({
        title: "Success",
        description: "Water issue report submitted successfully",
      })
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Submit details about water-related problems in your area</CardDescription>
      </CardHeader>
          ...
          <div className="grid gap-2">
            ...
            <Select value={issueType} onValueChange={setIssueType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="quality">Water Quality Concern</SelectItem>
